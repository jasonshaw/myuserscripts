...
// @include      http://lululu.cc/*
// @include      http://lululu.club/*
...
(function(){
    var configs = {
		...
		'lululuCC': {
			startReg: /^http:\/\/lululu\.club\/\d+.html$/i,
			autoCopyElements: ['div.dbox-content'],
			//autoCopyAttrs:['href'],
			autoCopyFilters:[/http:\/\/\S+/i],
			
		},
		'hkbicied2k': {
			startReg: /^http:\/\/hkbici\.com\/forum\.php\?mod=viewthread.+$/i,
			autoCopyElements: ['td[id^="postmessage_"] a[href^="ed2k://"]'],
			autoCopyAttrs:['href'],
		},
		'downg': {
